...
usage() {
    cat <<'EOF'
Usage: ./scripts/export-desktop-preferences.sh [OPTIONS]
...
render_keys_ini() {
    ...
    printf '# Desktop preference export generated by scripts/export-desktop-preferences.sh\n'
...
render_metadata_env() {
    ...
    printf '# Desktop preference metadata generated by scripts/export-desktop-preferences.sh\n'
